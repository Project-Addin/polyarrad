    ...
    <footer className="bg-navy border-t border-white/[0.06]">
      <div className="container mx-auto px-6 md:px-10 py-16 md:py-20">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-14">
          ...
          <div>
            <h4 className="text-white/80 font-semibold mb-5 text-[12px] tracking-[0.1em] uppercase">Navigasi</h4>
          ...
          <div>
            <h4 className="text-white/80 font-semibold mb-5 text-[12px] tracking-[0.1em] uppercase">Produk</h4>
            <ul className="space-y-2.5">
              {productLinks.map((l) => (
                <li key={l}>
                  <a
          ...
          <div>
            <h4 className="text-white/80 font-semibold mb-5 text-[12px] tracking-[0.1em] uppercase">Kontak</h4>
            <div className="text-white/50 text-[13px] space-y-2.5 leading-[1.6]">
