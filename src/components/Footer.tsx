const quickLinks = [
  ...
  { label: "Layanan Teknis", href: "#layanan" },
    ...
    <footer className="bg-navy border-t border-white/[0.06]">
      <div className="container mx-auto px-5 sm:px-6 md:px-10 py-12 sm:py-16 md:py-20">
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-14">
          ...
          <div>
            <h4 className="text-white/80 font-semibold mb-4 sm:mb-5 text-[11px] sm:text-[12px] tracking-[0.1em] uppercase">Navigasi</h4>
              ...
              {quickLinks.map((l) => (
                <li key={l.label}>
                  <a
                    ...
                    className="text-white/50 text-[12px] sm:text-[13px] hover:text-white transition-colors duration-300 py-0.5 inline-block"
                  >
                    {l.label}
                  </a>
                </li>
          ...
          <div>
            <h4 className="text-white/80 font-semibold mb-4 sm:mb-5 text-[11px] sm:text-[12px] tracking-[0.1em] uppercase">Produk</h4>
            <ul className="space-y-2 sm:space-y-2.5">
              {productLinks.map((l) => (
                <li key={l}>
                  <a
          ...
          <div className="col-span-2 sm:col-span-1">
            <h4 className="text-white/80 font-semibold mb-4 sm:mb-5 text-[11px] sm:text-[12px] tracking-[0.1em] uppercase">Kontak</h4>
