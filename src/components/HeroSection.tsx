...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="relative z-20 text-center px-5 sm:px-6 md:px-10 pt-24 pb-16 sm:pt-24 sm:pb-20 md:pt-24 md:pb-10 max-w-4xl mx-auto">
        ...
        >
          ...
          {t("hero.h1.line2")}
          <br />
          <span className="text-gradient">{t("hero.h1.line3")}</span>
        </h1>
      ...
      <div
        ...
        style={{ zIndex: 1 }}
      >
        <div className="absolute top-[3%] left-1/2 -translate-x-1/2 w-[55%] h-[35%] rounded-full blur-[200px] animate-pulse-soft" style={{ background: "hsl(var(--ocean) / 0.12)" }} />
        <div className="absolute top-[8%] left-1/2 -translate-x-1/2 w-[45%] h-[45%] rounded-full blur-[180px]" style={{ background: "hsl(var(--navy) / 0.80)" }} />
        <iframe
        ...
        />
        <div className="absolute top-0 left-0 right-0 h-[30%] z-20 pointer-events-none" style={{ background: "linear-gradient(to bottom, hsl(var(--navy)) 0%, hsl(var(--navy) / 0.5) 50%, transparent 100%)" }} />
        <div className="absolute inset-0 z-20 pointer-events-none" style={{ background: "linear-gradient(90deg, hsl(var(--navy)) 0%, transparent 15%, transparent 85%, hsl(var(--navy)) 100%)" }} />
      </div>

      {/* 3D Globe — mobile */}
      <div className="md:hidden absolute bottom-0 left-1/2 -translate-x-1/2 w-[140vw] h-[200px] pointer-events-none opacity-30" style={{ zIndex: 2 }}>
        <div className="absolute top-[0%] left-1/2 -translate-x-1/2 w-[70%] h-[40%] rounded-full blur-[80px] animate-pulse-soft" style={{ background: "hsl(var(--ocean) / 0.10)" }} />
        <iframe
          src="https://my.spline.design/holographicearthwithdynamiclines-YD0112HYpPLXTNpDwu6Gh3iB/"
          frameBorder="0"
          width="100%"
        ...
        />
        <div className="absolute top-0 left-0 right-0 h-[50%] z-20 pointer-events-none" style={{ background: "linear-gradient(to bottom, hsl(var(--navy)) 0%, hsl(var(--navy) / 0.4) 60%, transparent 100%)" }} />
        <div className="absolute inset-0 z-20 pointer-events-none" style={{ background: "linear-gradient(90deg, hsl(var(--navy)) 0%, transparent 25%, transparent 75%, hsl(var(--navy)) 100%)" }} />
      </div>

      {/* Bottom transition */}
      <div className="absolute bottom-0 left-0 right-0 h-32 sm:h-48 z-30" style={{ background: "linear-gradient(to top, hsl(var(--navy)) 0%, hsl(var(--navy) / 0.6) 40%, transparent 100%)" }} />
    </section>
  );
}
