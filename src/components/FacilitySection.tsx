...
export default function FacilitySection() {
  return (
    <section className="py-28 md:py-40 bg-card relative">
      <div className="container mx-auto px-6 md:px-10">
        <AnimatedSection>
          <div className="text-center mb-16 md:mb-20">
            ...
            <h2 className="text-3xl md:text-[2.75rem] font-bold text-foreground leading-[1.1] max-w-xl mx-auto">
          ...
          <AnimatedSection delay={150}>
            <div className="grid grid-cols-2 gap-4">
              {highlights.map((item) => (
                <div
                  key={item.label}
                  className="bg-secondary/40 rounded-xl border border-border/60 p-6 flex flex-col gap-3"
                >
                  <div className="w-10 h-10 rounded-lg bg-ocean/8 flex items-center justify-center">
